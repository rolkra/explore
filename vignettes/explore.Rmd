...
The explore package simplifies Exploratory Data Analysis (EDA). Get faster insights with less code! There are three ways to use the package: **interactive data exploration**, generate an **automated report** or use low code for **manual exploration** (`explore()`, `describe()`, `explain_*()`, `report()` , `abtest()`, ...)  
