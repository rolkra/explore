...
Interactive data exploration with one line of code or use a easy to remember set of tidy functions to explore your data. Introduces two main verbs for data analysis. **describe()** to describe a variable or table, **explore()** to grafically explore a variable or table.
