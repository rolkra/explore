...
* **Manual exploration** using a easy to remember set of tidy functions. Introduces two main verbs. **describe()** to describe a variable or table, **explore()** to grafically explore a variable or table.
