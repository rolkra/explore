...
| drop_na()      | {tidyr}   | drop observations containing NA values  |
...
So we have to load the palmerpenguins package. Furthermore, we use the packages {dplyr} for %>%, {tidyr} for drop_na() and {explore} for data exploration.
