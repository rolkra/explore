...
To explore all variables, we can simply use explore_all(). You automatically fit the height of the plot using `fig.height=total_fig_height(titanic, n = Freq)` in the code chunk header.

```{r message=FALSE, warning=FALSE, fig.width=6, fig.height=total_fig_height(titanic, n = Freq)}
